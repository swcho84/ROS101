...
void TurtleSimCmdPubLib::MainLoop()
{
  ...
  // for debugging
  // ROS_INFO("rpy:(%.4lf,%.4lf,%.4lf)", joyTurtleSimCtrlCmd_.ctrlMove.fRoll, joyTurtleSimCtrlCmd_.ctrlMove.fPitch, joyTurtleSimCtrlCmd_.ctrlMove.fYaw); 
  // ROS_INFO("throttle:(%.4lf)", joyTurtleSimCtrlCmd_.ctrlMove.fThr);
  // ROS_INFO("(auto,joy):(%d,%d)", (int)(joyTurtleSimCtrlCmd_.bCtrlAutoMode), (int)(joyTurtleSimCtrlCmd_.bCtrlJoyMode));
  // ROS_INFO("feature(1,2):(%d,%d)", joyTurtleSimCtrlCmd_.nRgearStatus, joyTurtleSimCtrlCmd_.nDgearStatus);
  // ROS_INFO(" ");
