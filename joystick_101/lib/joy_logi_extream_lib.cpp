...
JoyCtrlCmd JoyLogiExtream::GenJoyCtrlBtnsRefInfo(JoyRaw param, sensor_msgs::Joy joyRaw, JoyCtrlCmd res)
{
  ...
  // assigning gear status, temporary: kari antidrone gimbal control
  res.nRgearStatus = joyRaw.buttons[param.ctrlButton.nTrigRgear];
  res.nDgearStatus = joyRaw.buttons[param.ctrlButton.nTrigDgear];
  res.nShootStatus = joyRaw.buttons[param.ctrlButton.nTrigShoot];
  res.nIrImgModeStatus = joyRaw.buttons[param.ctrlButton.nTrigIrImgMode];
  res.nAllImgModeStatus = joyRaw.buttons[param.ctrlButton.nTrigAllImgMode];
  res.nStabModeStatus = joyRaw.buttons[param.ctrlButton.nTrigStabMode];
  res.nPosModeStatus = joyRaw.buttons[param.ctrlButton.nTrigPosMode];
  res.nVelModeStatus = joyRaw.buttons[param.ctrlButton.nTrigVelMode];    
  return res;
}
