...
bool ConfigParam::ReadRosParams()
{
  try
  {
    ...
    ReadRosParam(nh, "/Joystick/viewlinkJoyGimbalCtrlTopicName", strViewLinkJoyCtrlTpNm);
    ReadRosParam(nh, "/Joystick/viewlinkJoySelect", strViewLinkJoySelect);
    ...
    ReadRosParam(nh, "/Joystick/commandParam/scaleGimbalRate/pan", dGimbalPanRateScale);
    ReadRosParam(nh, "/Joystick/commandParam/scaleGimbalRate/tilt", dGimbalTiltRateScale);
    ReadRosParam(nh, "/Joystick/commandParam/scaleGimbalAng/pan", dGimbalPanAngScale);
    ReadRosParam(nh, "/Joystick/commandParam/scaleGimbalAng/tilt", dGimbalTiltAngScale);
    // fAttPsi = (fAttPsi) * (D2R);
    ...
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerRgear", joyCfgLoXtrm.ctrlButton.nTrigRgear);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerDgear", joyCfgLoXtrm.ctrlButton.nTrigDgear);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerShoot", joyCfgLoXtrm.ctrlButton.nTrigShoot);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerIrImgMode", joyCfgLoXtrm.ctrlButton.nTrigIrImgMode);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerAllImgMode", joyCfgLoXtrm.ctrlButton.nTrigAllImgMode);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerStabMode", joyCfgLoXtrm.ctrlButton.nTrigStabMode);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerPosMode", joyCfgLoXtrm.ctrlButton.nTrigPosMode);
    ReadRosParam(nh, "/Joystick/LogiTechExtream/button/triggerVelMode", joyCfgLoXtrm.ctrlButton.nTrigVelMode);
