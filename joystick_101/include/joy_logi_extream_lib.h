#ifndef JOYSTICK_101_JOY_LOGI_EXTREAM_LIB_H
#define JOYSTICK_101_JOY_LOGI_EXTREAM_LIB_H
...
class JoyLogiExtream
{
public:
  JoyLogiExtream(const ConfigParam& cfg);
  ~JoyLogiExtream();
...
#endif  // JOYSTICK_101_JOY_LOGI_EXTREAM_LIB_H